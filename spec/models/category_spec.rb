...
describe Category do
  ...
  describe "#recent_videos" do
    it "returns array of videos ordered by created at" do
      ...
      family_guy = Video.create(name: "Family Guy", description: "peter griffin", category: category)
      south_park = Video.create(name: "South Park", description: "cartman", category: category, created_at: 1.day.ago)
    ...
    it "returns six videos if there are more" do
      category = Category.create(name: "comedies")
      7.times {Video.create(name: 'Vid', description: 'desc', category: category)}
